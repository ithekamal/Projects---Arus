...
let yearToSearch:string = '2021'    
let bugNumber:string = '#11'
let nameOfFeature:string = 'GESTURES'
let t:any = 'PATCH'
...
function mostContriputes(appInfo:any){
    ...
    console.log(`Most contributions By ${sorted[0].name}\nNo of contributions : ${sorted[0].contributions} `)}


console.log('----\nRelease Made in Year')
infoByYear(yearToSearch)
console.log('----\nSearch By BUG ID')
infoBybugno(bugNumber)
console.log('----\nSearch By Name Of feature')
infoByFeature(nameOfFeature)
console.log('----\nInfo By Update')
infoByTypeOfUpdate(ref,instagram)
console.log('----\nMost Contriputions')
